...
class ped_stateRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ped_stateRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ped_stateRequest
    let len;
    let data = new ped_stateRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ped_stateRequest(null);
...
class ped_stateResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ped_stateResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ped_stateResponse
    let len;
    let data = new ped_stateResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ped_stateResponse(null);
    if (msg.px !== undefined) {
      resolved.px = msg.px;
    }
    else {
...
module.exports = {
  Request: ped_stateRequest,
  Response: ped_stateResponse,
  md5sum() { return '05beeb87454630bfc7ea88a89fd9b876'; },
  datatype() { return 'gazebo_sfm_plugin/ped_state'; }
};
