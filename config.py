...
# Vehicle
max_turning_angle: float = math.pi / 3  # In radians
vehicle_length: float = 10  # In pixels
vehicle_width: float = 5  # In pixels
...
# Debug
debug: bool = False  # Run while program running
